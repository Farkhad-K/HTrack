...
public interface IAttendancesService
{
    ...
    ValueTask<Attendance?> HandleAttendanceAsync(Guid companyId, string rfidCardUID, AttendanceEntrySource source, CancellationToken cancellationToken = default);
    ValueTask<AttendanceActionResult> HandleAttendanceWithResultAsync(Guid companyId, string rfidCardUID, CancellationToken cancellationToken = default);
    ValueTask<AttendanceActionResult> HandleAttendanceWithResultAsync(Guid companyId, string rfidCardUID, AttendanceEntrySource source, CancellationToken cancellationToken = default);
